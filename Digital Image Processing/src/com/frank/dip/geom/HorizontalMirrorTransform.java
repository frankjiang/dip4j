...
/**
 * The horizontal mirror transform.
 * <p>
 * </p>
 * 
 ...
 * @version 1.0.0
 */
public class HorizontalMirrorTransform implements GeometryTransform
{
	/**
	...
	/**
	 * The center line of X coordinate.
	 */
	protected double	centerX;

	/**
	 * Construct an instance of <tt>HorizontalMirrorTransform</tt>.
	 * 
	 * @param width
	 *            the width of source image
	 * @param height
	 */
	public HorizontalMirrorTransform(int width, int height)
	{
		this.width = width;
		this.height = height;
	}
	...
	public Point2D transform(Point2D src, Point2D dst)
	{
		...
		dst.setLocation(width - src.getX(), src.getY());
		return dst;
	}
